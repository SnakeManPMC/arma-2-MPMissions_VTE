...
[[
  ...
  ["Mission","First Huey is on <marker name='start'>FOB Gator</marker>, secon huey is on <marker name='fob_jackal'>FOB Jackal</marker>. Clear out all the objective villages from enemy presence."],
