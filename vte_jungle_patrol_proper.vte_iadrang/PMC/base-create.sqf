...
while {_A < _c} do
{
	...
	// camp fire burning
	_fireb1 = "land_campfire" createVehicle [(_fish select 0) + 5, (_fish select 1), 0];
	_fireb1 inFlame true;
	_fireb1 setDir random 360;

	// tents
	_tentb1 = "campeast" createVehicle [(_fish select 0) + 10, (_fish select 1) + 10, 0];
	...
	// sheds
	_shedb1 = "barrels" createVehicle [(_fish select 0) - 20, (_fish select 1), 0];
	_shedb1 setDir random 360;
	_shedsmallb1 = "barrels" createVehicle [(_fish select 0), (_fish select 1) - 10, 0];
	_shedsmallb1 setDir random 360;

	// barrels stuff
	_barrels1b1 = "Barrels" createVehicle [(_fish select 0) - 20, (_fish select 1), 0];
