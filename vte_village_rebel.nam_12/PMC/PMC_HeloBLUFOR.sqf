/*
	...
	05-11-15: squint checked, works ok. NO idea if this is latest VTE version of PMC_HeloBLUFOR.sqf, its a mess! :)
...
_PMC_MakeHeloBLUFOR =
{
	private ["_myVec","_helos","_vcl","_respawnpoint","_grp","_wp","_targetpoint"];
	_helos =
	[
