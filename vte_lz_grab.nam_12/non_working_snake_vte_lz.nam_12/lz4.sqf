...
private ["_grp","_pos","_hq","_WaitTime","_unit1","_unit2","_pln","_helopos","_abox1","_abox2","_flg1"];
_pos = getPosASL leader assault1;
_hq = getPosASL base_rock;

_WaitTime=60;

"PMC_mklz4" setmarkerpos _pos;
"PMC_mklz4" setmarkercolor "ColorBlue";
"PMC_mklz4" setmarkertype "Marker";
...
waitUntil {unitready leader _grp || !alive _pln};
...
["PMC_mklz4",usinf1] execVM "lz-security.sqf";
