...
private [
	"_vcl", "_grp", "_ptNum", "_ran", "_tlogic", "_targetpoint",
	"_respawnpoint", "_a", "_p", "_targetNum", "_PMC_convoyOPFORtargets",
	"_PMC_CreateConvoyVehicles", "_crewClass"
];
...
// whats our crew class name
_crewClass = "vte_nvacrew";
