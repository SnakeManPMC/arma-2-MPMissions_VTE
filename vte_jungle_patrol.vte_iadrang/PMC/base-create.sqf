...
while {_A < _c} do
{
	...
	// camp fire burning
	_fireb1 = "land_campfire" createVehicle [_bx+5,_by];
	_fireb1 inFlame true;
	_fireb1 setDir random 360;

	// tents
	_tentb1 = "campeast" createVehicle [_bx+10,_by+10];
	...
	// sheds
	_shedb1 = "barrels" createVehicle [_bx-20,_by];
	_shedb1 setDir random 360;
	_shedsmallb1 = "barrels" createVehicle [_bx,_by-10];
	_shedsmallb1 setDir random 360;

	// barrels stuff
	_barrels1b1 = "Barrels" createVehicle [_bx-20,_by];
